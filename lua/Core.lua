if not _G.WolfHUD then
	...
	WolfHUD.hook_files = WolfHUD.hook_files or {
		...
		["lib/managers/hudmanagerpd2"] = { "CustomHUD.lua", "BurstFire.lua", "HUDChat.lua", "HUDList.lua", "KillCounter.lua", "DownCounter.lua", "DrivingHUD.lua", "DamageIndicator.lua", "Interaction.lua", "AdvAssault.lua" },
