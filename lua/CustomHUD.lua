...
if RequiredScript == "lib/managers/hud/hudteammate" then
	...
	HUDTeammateCustom.SETTINGS = {
		...
		PLAYER = {
			...
			CALLSIGN = false,	--Show the callsign and voice chat icon
	...
	function HUDTeammateCustom:init(id, panel, is_player, alignment)
		...
		self._kills = PlayerInfoComponent.KillCounter:new(self._panel, self, name_size * 0.8, self._settings.KILL_COUNTER)
	...
	function PlayerInfoComponent.HealthRadial:init(panel, owner, teammate_panel, size, is_player)
		...
		self._has_messiah = is_player and managers.player:has_category_upgrade("player", "pistol_revive_from_bleed_out")
	...
	function PlayerInfoComponent.Weapon:set_weapon(id, silencer)
		...
		self._icon_panel:child("icon"):set_texture_rect(256, 0, -256, 128)
	...
	function PlayerInfoComponent.KillCounter:init(panel, owner, height, settings)
		...
		self._show_special_kills = settings.SHOW_SPECIAL_KILLS
		self._show_headshot_kills = settings.SHOW_HEADSHOT_KILLS
